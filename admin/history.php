    ...
    <div class="lg:ml-64 min-h-screen">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                        ...
                        <p class="text-lg font-bold text-blue-400"><?php echo number_format($stats['total_searches'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main class="p-6">
            ...
            <?php if ($success === 'deleted'): ?>
                <div class="mb-6 bg-green-900 border border-green-700 text-green-400 px-4 py-3 rounded-lg flex items-center">
            ...
            <?php if ($error): ?>
                <div class="mb-6 bg-red-900 border border-red-700 text-red-400 px-4 py-3 rounded-lg flex items-center">
                ...
                <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-blue-400 mt-2"><?php echo number_format($stats['total_searches'] ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-400 mt-2"><?php echo number_format($stats['total_results'] ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-purple-400 mt-2"><?php echo number_format($stats['total_tokens'] ?? 0); ?></p>
                        </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-red-400 mt-2"><?php echo number_format($stats['avg_results'] ?? 0, 1); ?></p>
                        </div>
                        ...
                        <?php foreach ($type_stats as $type): ?>
                            <div class="bg-gray-700 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-sm font-bold text-blue-400"><?php echo $type['count']; ?></span>
                                </div>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-white flex items-center">
                            ...
                            <?php if ($total_searches > 0): ?>
                                <span class="ml-2 bg-blue-900 text-blue-400 px-3 py-1 rounded-full text-sm font-medium">
                ...
                <?php if (empty($searches)): ?>
                    <div class="text-center py-16">
                        ...
                        <a href="search.php" class="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all font-medium">
                            ...
                            <tbody class="divide-y divide-gray-700">
                                <?php foreach ($searches as $search): ?>
                                    <tr class="hover:bg-gray-700 transition-all">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-white font-medium max-w-xs truncate" title="<?php echo htmlspecialchars($search['query']); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                ...
                                                if ($type === 'email') echo 'bg-blue-900 text-blue-400';
                                                elseif ($type === 'username') echo 'bg-green-900 text-green-400';
                                                elseif ($type === 'name') echo 'bg-purple-900 text-purple-400';
                                                elseif ($type === 'phone') echo 'bg-red-900 text-red-400';
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <?php if ($search['results_count'] > 0): ?>
                                                    <a href="results.php?id=<?php echo $search['id']; ?>" 
                                                       class="bg-blue-900 text-blue-400 px-3 py-2 rounded-lg hover:bg-blue-800 transition-all text-sm font-medium flex items-center group"
                                                    ...
                                                    <a href="export.php?id=<?php echo $search['id']; ?>&format=html" 
                                                       class="bg-green-900 text-green-400 px-3 py-2 rounded-lg hover:bg-green-800 transition-all text-sm font-medium flex items-center group"
                                                ...
                                                <button onclick="confirmDelete(<?php echo $search['id']; ?>, '<?php echo htmlspecialchars($search['query']); ?>')" 
                                                        class="bg-red-900 text-red-400 px-3 py-2 rounded-lg hover:bg-red-800 transition-all text-sm font-medium flex items-center group"
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-8 max-w-md w-full">
                    <div class="text-center">
                        ...
                        <div class="bg-gray-700 rounded-lg p-3 mb-6">
                            ...
                            <p class="text-blue-400 font-mono text-sm break-all">${query}</p>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <button onclick="deleteSearch(${searchId})" 
                                    class="flex-1 bg-red-600 text-white px-4 py-3 rounded-lg hover:bg-red-700 transition-all font-medium">
